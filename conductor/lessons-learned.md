...
- (2026-04-19, convex-types) Creating a new Convex handler file (e.g., rateLimits.ts) does not auto-register it in generated types; must run `npx convex dev` to regenerate api.d.ts before TypeScript recognizes the new namespace in `internal`
