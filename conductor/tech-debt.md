...
| 2026-04-11 | graphing-components | InterceptIdentification tests expect coordinates that don't match mathematical coordinate system | Medium | Open | 4/23 tests fail because test coordinates (e.g., (100, 300) for x=-3) don't match actual canvas coordinates (210, 200 for x=-3) |
