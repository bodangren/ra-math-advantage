...
- [ ] Create `app/api/phases/complete/route.ts` — POST endpoint for phase completion with idempotency

## Phase 3: Auth Pages

- [ ] Create `app/auth/layout.tsx` — Centered layout for auth pages (minimal chrome)
