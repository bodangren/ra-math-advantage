...
- [ ] Task: Verify lesson 5-2 curriculum source
  - [ ] Confirm title and phase sequence against `curriculum/modules/module-5-lesson-2`
  - [ ] Confirm equation and inequality solving examples preserve solution logic
- [ ] Task: Create seed function `convex/seed/seed-lesson-5-2.ts`
  - [ ] Write tests for phase sequence and idempotency
  - [ ] Implement lesson, phases, sections, and activities
- [ ] Task: Conductor - Phase Completion Verification 'Seed Lesson 5-2' (Protocol in workflow.md)
