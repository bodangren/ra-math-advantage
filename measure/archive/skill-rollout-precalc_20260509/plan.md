...
- [x] **Task 1.1: Verify PreCalc source hierarchy**
...
- [x] **Task 1.2: Inventory current PreCalc graph-relevant artifacts**
  - Topic files.
...
- [x] **Task 2.1: Generate PreCalc nodes**
  - course, unit, topic/lesson, skill, worked_example, standard, problem_family nodes.

- [x] **Task 2.2: Generate CED learning-objective edges**
...
- [x] **Task 2.3: Validate source coverage**
...
- [x] **Task 3.3: Preserve AP task context**
...
- [x] **Task 6.1: Write PreCalc rollout audit**
