...
def load_config() -> Config:
    ...
    return Config(
        ...
        jr_model=os.environ.get("JR_MODEL", "minimax-cn-coding-plan/MiniMax-M3"),
        review_model=os.environ.get("REVIEW_MODEL", "kimi-for-coding/k2p7"),
        phase_acceptance_model=os.environ.get("PHASE_ACCEPTANCE_MODEL", "kimi-for-coding/k2p7"),
        adversarial_model=os.environ.get("ADVERSARIAL_MODEL", "minimax-cn-coding-plan/MiniMax-M3"),
        ux_model=os.environ.get("UX_MODEL", "kimi-for-coding/k2p7"),
        acceptance_model=os.environ.get("ACCEPTANCE_MODEL", "vocengine-coding/deepseek-v4-pro"),
        closeout_model=os.environ.get("CLOSEOUT_MODEL", "opencode-go/deepseek-v4-flash"),
