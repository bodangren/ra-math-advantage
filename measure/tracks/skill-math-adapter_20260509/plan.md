...
- [x] **Task 1.1: Add ID validation tests**
...
- [x] **Task 1.2: Add metadata validation tests**
...
- [x] **Task 1.3: Add registry round-trip tests**
...
- [x] **Task 1.4: Add practice.v1 evidence bridge tests**
...
- [x] **Task 2.4: Implement renderer registry**
