...
- [~] Task: E2E assertions per major activity type (Red→Green) (Red: `0367d7a6`)
- [~] Task: E2E spec for a daily-practice session incl. SRS completion/streak (Red→Green) (Red: `0367d7a6`)
