...
### 1-2 Solving Quadratics by Graphing
...
### 1-4 Solving by Factoring
Students factor trinomials and apply the zero product property.

### 1-5 Completing the Square
Conceptual development of completing the square, linking to vertex form.

### 1-6 Quadratic Formula and Discriminant
Derivation (conceptual) and application; interpreting discriminant for number/type of solutions.

### 1-7 Quadratic Inequalities
Graphing solution regions and interpreting intervals.

### 1-8 Linear-Quadratic Systems
Solving systems graphically and algebraically; interpreting intersections.
