...
export const UNIT4_PROBLEM_FAMILIES: ProblemFamilyInput[] = [
  ...
  {
    variantKey: "graphing-explorer:parametric-motion",
  ...
  {
    variantKey: "step-by-step-solver:parametric-rectangular",
  ...
  {
    variantKey: "graphing-explorer:conic-sections",
    componentKey: "graphing-explorer",
  ...
  {
    variantKey: "step-by-step-solver:vector-components",
    componentKey: "step-by-step-solver",
  ...
  {
    variantKey: "step-by-step-solver:vector-operations",
    componentKey: "step-by-step-solver",
  ...
  {
    variantKey: "comprehension-quiz:vector-applications",
  ...
  {
    variantKey: "graphing-explorer:vector-valued-functions",
    componentKey: "graphing-explorer",
  ...
  {
    variantKey: "step-by-step-solver:matrix-operations",
    componentKey: "step-by-step-solver",
  ...
  {
    variantKey: "comprehension-quiz:matrix-properties",
    componentKey: "comprehension-quiz",
  ...
  {
    variantKey: "step-by-step-solver:matrix-systems",
    componentKey: "step-by-step-solver",
  ...
  {
    variantKey: "graphing-explorer:matrix-transformations",
    componentKey: "graphing-explorer",
