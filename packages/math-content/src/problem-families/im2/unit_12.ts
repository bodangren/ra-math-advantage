...
export const UNIT12_PROBLEM_FAMILIES: ProblemFamilyInput[] = [
  // Graphing Quadratics
  {
    variantKey: "graphing-explorer:graphing-quadratic-functions",
  ...
  {
    variantKey: "step-by-step-solver:factoring-quadratics",
  ...
  {
    variantKey: "step-by-step-solver:completing-the-square",
    componentKey: "step-by-step-solver",
  ...
  // Quadratic Formula
  {
    variantKey: "step-by-step-solver:quadratic-formula",
    componentKey: "step-by-step-solver",
  ...
  {
    variantKey: "step-by-step-solver:quadratic-applications",
    componentKey: "step-by-step-solver",
