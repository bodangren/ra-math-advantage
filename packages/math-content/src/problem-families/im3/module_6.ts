...
export const MODULE6_PROBLEM_FAMILIES: ProblemFamilyInput[] = [
  ...
  {
    variantKey: "step-by-step-solver:logarithmic-exponential-form",
  ...
  {
    variantKey: "graphing-explorer:exponential-functions-log",
    componentKey: "graphing-explorer",
  ...
  {
    variantKey: "step-by-step-solver:solve-logarithmic-equations",
    componentKey: "step-by-step-solver",
  ...
  {
    variantKey: "step-by-step-solver:properties-of-logarithms",
    componentKey: "step-by-step-solver",
  ...
  {
    variantKey: "step-by-step-solver:change-of-base",
    componentKey: "step-by-step-solver",
  ...
  {
    variantKey: "step-by-step-solver:natural-logarithms",
    componentKey: "step-by-step-solver",
  ...
  {
    variantKey: "step-by-step-solver:continuous-growth-decay",
    componentKey: "step-by-step-solver",
  ...
  {
    variantKey: "step-by-step-solver:compare-exponential-logarithmic",
    componentKey: "step-by-step-solver",
  ...
  // Comprehension
  {
    variantKey: "comprehension-quiz:logarithmic-vocabulary",
