...
export const MODULE8_PROBLEM_FAMILIES: ProblemFamilyInput[] = [
  ...
  {
    variantKey: "comprehension-quiz:sampling-methods",
  ...
  {
    variantKey: "comprehension-quiz:probability-simulations",
    componentKey: "comprehension-quiz",
  ...
  {
    variantKey: "comprehension-quiz:data-distributions",
    componentKey: "comprehension-quiz",
  ...
  {
    variantKey: "comprehension-quiz:two-variable-data",
    componentKey: "comprehension-quiz",
  ...
  {
    variantKey: "comprehension-quiz:normal-distribution",
    componentKey: "comprehension-quiz",
  ...
  {
    variantKey: "comprehension-quiz:confidence-intervals",
    componentKey: "comprehension-quiz",
  ...
  {
    variantKey: "graphing-explorer:statistical-graphs",
