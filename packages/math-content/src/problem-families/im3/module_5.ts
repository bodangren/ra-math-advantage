...
export const MODULE5_PROBLEM_FAMILIES: ProblemFamilyInput[] = [
  ...
  {
    variantKey: "graphing-explorer:exponential-growth",
  ...
  {
    variantKey: "graphing-explorer:exponential-decay",
    componentKey: "graphing-explorer",
  ...
  {
    variantKey: "step-by-step-solver:solve-exponential-equations",
  ...
  {
    variantKey: "step-by-step-solver:exponential-models",
    componentKey: "step-by-step-solver",
  ...
  {
    variantKey: "step-by-step-solver:natural-base-e",
    componentKey: "step-by-step-solver",
  ...
  {
    variantKey: "graphing-explorer:exponential-base-e",
    componentKey: "graphing-explorer",
  ...
  {
    variantKey: "step-by-step-solver:geometric-sequences",
    componentKey: "step-by-step-solver",
  ...
  {
    variantKey: "step-by-step-solver:geometric-series",
    componentKey: "step-by-step-solver",
  ...
  {
    variantKey: "step-by-step-solver:compare-exponential-linear",
    componentKey: "step-by-step-solver",
  ...
  {
    variantKey: "graphing-explorer:exponential-vs-linear",
    componentKey: "graphing-explorer",
  ...
  // Comprehension
  {
    variantKey: "comprehension-quiz:exponential-vocabulary",
