# Topic 4.7: Parametrization of Implicitly Defined Functions

## CED Identity

- Unit: 4
- Unit title: Functions Involving Parameters, Vectors, and Matrices
- AP Exam status: `not-assessed-on-ap-exam`
- CED topic ID: `4.7`
- Learning-objective family: `4.7.A`
- Essential-knowledge family: `4.7.A.*`
...
- Passwater instructional source: not available
