// Authored Unit 1 lessons — formerly generated, now hand-maintained.
// SOURCE REMOVED: the generator (scripts/generate-unit1-authored-module.ts) and
// its supabase/seed/unit1 source modules were deleted in the BM2 Drizzle
// dead-layer removal (commit 369cd52f). There is no regeneration step anymore —
// this file is the canonical source. Edit it directly.
