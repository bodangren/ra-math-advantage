 ...
 *
 * @param {CompetencyHeatmapResponse} heatmapData - The heatmap response containing rows and standards data.
 * @returns {JSX.Element} The competency heatmap page JSX element.
 */
