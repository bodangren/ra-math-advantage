...
describe('seed-lesson-2-5', () => {
  describe('Lesson 2-5: Powers of Binomials', () => {
    const lesson2Seed: SeedLesson = {
      ...
      phases: [
        ...
        { phaseNumber: 3, title: 'Learn: Powers of Binomials', phaseType: 'learn', sections: [] },
    ...
    it('lesson has correct metadata', () => {
      ...
      expect(lesson2Seed.title).toBe('Powers of Binomials');
      expect(lesson2Seed.slug).toBe('module-2-lesson-5');
      expect(lesson2Seed.orderIndex).toBe(5);
    });

    it('has exactly 8 phases', () => {
      expect(lesson2Seed.phases).toHaveLength(8);
    });

    it('correct phase sequence: explore, vocab, learn, 3×worked_example, discourse, reflection', () => {
  ...
  describe('activity records for lesson 2-5', () => {
